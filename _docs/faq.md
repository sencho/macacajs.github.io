...
- [Promise 编写异步测试用例](https://github.com/alibaba/macaca/issues/26)
- [导出测试报告失败](https://github.com/alibaba/macaca/issues/13)
- [Android SDK版本引起的安装失败](https://github.com/alibaba/macaca/issues/7)
